...
<div class="exec-container">
  ...
  <div class="exec-step exec-step-blue">
    ...
    <div class="exec-step-body">
      <div class="exec-cmd">
        <span class="exec-prompt">$</span> fluid run-source my-golden-vm "systemctl status nginx"
      </div>
    </div>
  </div>
  ...
  <div class="exec-step exec-step-purple">
    ...
    <ul class="exec-step-details">
      ...
      <li>
        If expired: generate Ed25519 keypair, sign certificate with principal "fluid-readonly" and
        30-min TTL
      </li>
