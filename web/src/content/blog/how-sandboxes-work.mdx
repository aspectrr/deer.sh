---
title: 'How Deer.sh Sandboxes Work'
pubDate: 2026-02-25
...
<div class="sbx-diagram-container">
  ...
  <div class="sbx-flow-vertical">
    <div class="sbx-flow-card">
      ...
      <div class="sbx-flow-card-body">
        QCOW2 cloud image (e.g. Ubuntu 24.04)
        <br />
        Stored read-only in image cache
      </div>
    </div>
    ...
    <div class="sbx-flow-card">
      ...
      <div class="sbx-flow-card-body">
        virt-cat /boot/vmlinuz-* from image
        <br />
        Decompress to .vmlinux (cached)
      </div>
    </div>
    <div class="sbx-flow-arrow">&#8595;</div>
    <div class="sbx-flow-card">
    ...
    <div class="sbx-flow-card">
      ...
      <div class="sbx-flow-card-body">
        ...
        <br />
        Generate random 52:54:00:xx:xx:xx MAC
      </div>
    </div>
    <div class="sbx-flow-arrow">&#8595;</div>
    <div class="sbx-flow-card sbx-flow-card-highlight">
      ...
      <div class="sbx-flow-card-body">
        -M microvm -enable-kvm -cpu host
        <br />
        Direct kernel boot, daemonized with PID tracking
      </div>
    </div>
    <div class="sbx-flow-arrow">&#8595;</div>
    <div class="sbx-flow-card">
      ...
      <div class="sbx-flow-card-body">
        Poll ARP table / lease files for MAC
        <br />
        Sandbox ready when IP resolves
      </div>
    </div>
  </div>
</div>
...
```
qemu-img create -f qcow2 -b /var/lib/deer/images/ubuntu-24.04.qcow2 -F qcow2 \
  /var/lib/deer/overlays/<sandbox-id>/disk.qcow2
```
...
<BlogInlineCTA feature="This is how Fluid creates sandboxes in milliseconds with zero disk overhead - try it on your own servers." />
...
- **dnsmasq**: Reads lease files from `/var/lib/deer/dnsmasq/`.
...
**Setup**: The daemon generates an Ed25519 CA keypair on first run (`ssh-keygen -t ed25519`). The CA public key is baked into base images so sandboxes trust it from boot. The private key stays on the daemon host at `/etc/deer/ssh_ca` with `0600` permissions.
...
<BlogInlineCTA feature="This is how Fluid handles SSH access with ephemeral certificates - try it on your own servers." />
...
<div class="sbx-diagram-container">
  ...
  <div class="sbx-flow-horizontal">
    ...
    <div class="sbx-flow-card sbx-hflow-card">
      ...
      <div class="sbx-flow-card-body">
        ssh -i key -o CertificateFile=cert
        <br />
        sandbox@10.0.0.x
        <br />
...
<div class="sbx-diagram-container">
  ...
  <div class="sbx-flow-vertical">
    ...
    <div class="sbx-flow-card">
      ...
      <div class="sbx-flow-card-body">
        Lookup sandbox IP + SSH credentials
        <br />
        Open SSH session to sandbox@10.0.0.x
      </div>
    </div>
