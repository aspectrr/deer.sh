...
VM_NAME="${1:-test-vm}"
SSH_CA_PUB_PATH="${2:-${SSH_CA_PUB_PATH:-/etc/deer/ssh_ca.pub}}"
SSH_CA_KEY_PATH="${3:-${SSH_CA_KEY_PATH:-/etc/deer/ssh_ca}}"
...
create_cloud_init_iso() {
    ...
    if [[ -f "$SSH_CA_PUB_PATH" ]]; then
        ...
        ca_pub_key="ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIO0e/MeLFYx1jCQv0qFJvSBEco+2z9TYrwN6wQAlR31E deer-ssh-ca"
...
runcmd:
  - echo "Test VM is ready for deer.sh testing" > /etc/motd
