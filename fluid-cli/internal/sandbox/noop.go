...
const noSandboxMsg = "No sandbox hosts configured. Configure a sandbox host to create sandboxes, run commands, and edit files. Daemon setup guide: https://fluid.sh/docs/daemon"
...
func (n *NoopService) CreateSandbox(ctx context.Context, req CreateRequest) (*SandboxInfo, error) {
	return nil, fmt.Errorf(noSandboxMsg)
}
...
func (n *NoopService) DestroySandbox(ctx context.Context, id string) error {
	return fmt.Errorf(noSandboxMsg)
}
