...
type SourceHostConfig struct {
	...
	SSHUser string `yaml:"ssh_user"` // default: deer-daemon
...
func DefaultConfig() Config {
	...
	return Config{
		...
		MicroVM: MicroVMConfig{
			...
			KernelPath:         "/var/lib/deer-daemon/vmlinuz",
			InitrdPath:         "/var/lib/deer-daemon/initrd.img",
			RootDevice:         "/dev/vda1",
			WorkDir:            "/var/lib/deer-daemon/overlays",
			DefaultVCPUs:       2,
