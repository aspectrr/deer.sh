...
class HostTokensApi:
    ...
    def orgs_slug_hosts_tokens_get(
        ...
        _param = self._orgs_slug_hosts_tokens_get_serialize(
            slug=slug,
    ...
    def orgs_slug_hosts_tokens_get_with_http_info(
        self,
        slug: str,
        _request_timeout: Union[None, float, Tuple[float, float]] = None,
        _request_auth: Optional[Dict[str, Any]] = None,
    ...
    def orgs_slug_hosts_tokens_get_without_preload_content(
        self,
        slug: str,
        _request_timeout: Union[None, float, Tuple[float, float]] = None,
        _request_auth: Optional[Dict[str, Any]] = None,
    ...
    def _orgs_slug_hosts_tokens_get_serialize(
        self,
        slug: str,
        ...
        if "Host_Tokens" not in _header_params:
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/orgs/{slug}/hosts/tokens",
    ...
    def orgs_slug_hosts_tokens_post(
        ...
        :param slug: Organization slug (required)
        :type slug: str
        :param request: Token details (required)
        :type request: RestCreateHostTokenRequest
        :param _request_timeout: Timeout setting for this request. If one
                                 number is provided, it will be the total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._orgs_slug_hosts_tokens_post_serialize(
            slug=slug,
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def orgs_slug_hosts_tokens_post_with_http_info(
        self,
        slug: str,
        request: RestCreateHostTokenRequest,
        _request_timeout: Union[None, float, Tuple[float, float]] = None,
        ...
        _headers: Optional[Dict[str, Any]] = None,
        _host_index: int = 0,
    ) -> ApiResponse[RestHostTokenResponse]:
        """Create host token
    ...
    def orgs_slug_hosts_tokens_post_without_preload_content(
        self,
        slug: str,
        request: RestCreateHostTokenRequest,
        _request_timeout: Union[None, float, Tuple[float, float]] = None,
    ...
    def _orgs_slug_hosts_tokens_post_serialize(
        self,
        slug: str,
        request: RestCreateHostTokenRequest,
        _request_auth: Optional[Dict[str, Any]],
    ...
    def orgs_slug_hosts_tokens_token_id_delete(
        ...
        _param = self._orgs_slug_hosts_tokens_token_id_delete_serialize(
            slug=slug,
            token_id=token_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def orgs_slug_hosts_tokens_token_id_delete_with_http_info(
        self,
        slug: str,
        token_id: str,
        _request_timeout: Union[None, float, Tuple[float, float]] = None,
    ...
    def orgs_slug_hosts_tokens_token_id_delete_without_preload_content(
        self,
        slug: str,
        token_id: str,
        _request_timeout: Union[None, float, Tuple[float, float]] = None,
    ...
    def _orgs_slug_hosts_tokens_token_id_delete_serialize(
        self,
        slug: str,
        token_id: str,
        _request_auth: Optional[Dict[str, Any]],
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/orgs/{slug}/hosts/tokens/{tokenID}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
