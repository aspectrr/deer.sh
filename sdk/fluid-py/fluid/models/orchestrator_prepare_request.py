...
class OrchestratorPrepareRequest(BaseModel):
    """
    OrchestratorPrepareRequest
    """  # noqa: E501

    ssh_key_path: Optional[StrictStr] = None
    ssh_user: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["ssh_key_path", "ssh_user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"ssh_key_path": obj.get("ssh_key_path"), "ssh_user": obj.get("ssh_user")}
        )
        return _obj
