...
class HostsApi:
    ...
    def orgs_slug_hosts_get(
        ...
        _param = self._orgs_slug_hosts_get_serialize(
            slug=slug,
    ...
    def orgs_slug_hosts_get_with_http_info(
        self,
        slug: str,
        _request_timeout: Union[None, float, Tuple[float, float]] = None,
        _request_auth: Optional[Dict[str, Any]] = None,
    ...
    def orgs_slug_hosts_get_without_preload_content(
        self,
        slug: str,
        _request_timeout: Union[None, float, Tuple[float, float]] = None,
        _request_auth: Optional[Dict[str, Any]] = None,
    ...
    def _orgs_slug_hosts_get_serialize(
        self,
        slug: str,
        ...
        if "Hosts" not in _header_params:
    ...
    def orgs_slug_hosts_host_id_get(
        ...
        _param = self._orgs_slug_hosts_host_id_get_serialize(
            slug=slug,
            host_id=host_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def orgs_slug_hosts_host_id_get_with_http_info(
        self,
        slug: str,
        host_id: str,
        _request_timeout: Union[None, float, Tuple[float, float]] = None,
        ...
        _headers: Optional[Dict[str, Any]] = None,
        _host_index: int = 0,
    ) -> ApiResponse[OrchestratorHostInfo]:
        """Get host
    ...
    def orgs_slug_hosts_host_id_get_without_preload_content(
        self,
        slug: str,
        host_id: str,
        _request_timeout: Union[None, float, Tuple[float, float]] = None,
    ...
    def _orgs_slug_hosts_host_id_get_serialize(
        self,
        slug: str,
        host_id: str,
        _request_auth: Optional[Dict[str, Any]],
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/orgs/{slug}/hosts/{hostID}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
