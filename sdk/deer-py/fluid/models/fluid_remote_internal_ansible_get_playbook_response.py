...
class FluidRemoteInternalAnsibleGetPlaybookResponse(BaseModel):
    """
    FluidRemoteInternalAnsibleGetPlaybookResponse
    """  # noqa: E501

    playbook: Optional[FluidRemoteInternalStorePlaybook] = None
    tasks: Optional[List[FluidRemoteInternalStorePlaybookTask]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "playbook": FluidRemoteInternalStorePlaybook.from_dict(obj["playbook"])
                if obj.get("playbook") is not None
                else None,
                "tasks": [
                    FluidRemoteInternalStorePlaybookTask.from_dict(_item)
