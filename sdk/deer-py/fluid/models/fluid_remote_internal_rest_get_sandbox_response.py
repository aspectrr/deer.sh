...
class FluidRemoteInternalRestGetSandboxResponse(BaseModel):
    """
    FluidRemoteInternalRestGetSandboxResponse
    """  # noqa: E501

    commands: Optional[List[FluidRemoteInternalStoreCommand]] = None
    sandbox: Optional[FluidRemoteInternalStoreSandbox] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "commands": [
                    FluidRemoteInternalStoreCommand.from_dict(_item)
                    for _item in obj["commands"]
                ]
                if obj.get("commands") is not None
                else None,
                "sandbox": FluidRemoteInternalStoreSandbox.from_dict(obj["sandbox"])
