...
class FluidRemoteInternalRestListSessionsResponse(BaseModel):
    """
    FluidRemoteInternalRestListSessionsResponse
    """  # noqa: E501

    sessions: Optional[List[FluidRemoteInternalRestSessionResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "sessions": [
                    FluidRemoteInternalRestSessionResponse.from_dict(_item)
