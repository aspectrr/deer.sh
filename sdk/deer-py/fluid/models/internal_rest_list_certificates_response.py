...
class InternalRestListCertificatesResponse(BaseModel):
    """
    InternalRestListCertificatesResponse
    """  # noqa: E501

    certificates: Optional[List[InternalRestCertificateResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "certificates": [
                    InternalRestCertificateResponse.from_dict(_item)
