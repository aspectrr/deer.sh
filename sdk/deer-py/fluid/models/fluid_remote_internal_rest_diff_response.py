...
class FluidRemoteInternalRestDiffResponse(BaseModel):
    """
    FluidRemoteInternalRestDiffResponse
    """  # noqa: E501

    diff: Optional[FluidRemoteInternalStoreDiff] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "diff": FluidRemoteInternalStoreDiff.from_dict(obj["diff"])
