...
class FluidRemoteInternalRestListSandboxesResponse(BaseModel):
    """
    FluidRemoteInternalRestListSandboxesResponse
    """  # noqa: E501

    sandboxes: Optional[List[FluidRemoteInternalRestSandboxInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "sandboxes": [
                    FluidRemoteInternalRestSandboxInfo.from_dict(_item)
