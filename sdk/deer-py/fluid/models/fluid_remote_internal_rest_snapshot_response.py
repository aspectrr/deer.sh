...
class FluidRemoteInternalRestSnapshotResponse(BaseModel):
    """
    FluidRemoteInternalRestSnapshotResponse
    """  # noqa: E501

    snapshot: Optional[FluidRemoteInternalStoreSnapshot] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "snapshot": FluidRemoteInternalStoreSnapshot.from_dict(obj["snapshot"])
