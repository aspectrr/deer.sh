...
class FluidRemoteInternalRestListVMsResponse(BaseModel):
    """
    FluidRemoteInternalRestListVMsResponse
    """  # noqa: E501

    vms: Optional[List[FluidRemoteInternalRestVmInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "vms": [
                    FluidRemoteInternalRestVmInfo.from_dict(_item)
