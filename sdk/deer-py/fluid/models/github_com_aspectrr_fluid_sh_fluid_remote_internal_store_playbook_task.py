...
class GithubComAspectrrFluidShFluidRemoteInternalStorePlaybookTask(BaseModel):
    """
    ...
    module: Optional[StrictStr] = Field(
    ...
    position: Optional[StrictInt] = Field(
        default=None, description="ordering within playbook"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "playbook_id": obj.get("playbook_id"),
