...
class FluidRemoteInternalStoreCommand(BaseModel):
    """
    ...
    metadata: Optional[FluidRemoteInternalStoreCommandExecRecord] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "id": obj.get("id"),
                "metadata": FluidRemoteInternalStoreCommandExecRecord.from_dict(
                    obj["metadata"]
                )
