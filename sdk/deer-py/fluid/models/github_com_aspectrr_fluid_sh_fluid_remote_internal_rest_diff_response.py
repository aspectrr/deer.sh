...
class GithubComAspectrrFluidShFluidRemoteInternalRestDiffResponse(BaseModel):
    """
    GithubComAspectrrFluidShFluidRemoteInternalRestDiffResponse
    """  # noqa: E501

    diff: Optional[GithubComAspectrrFluidShFluidRemoteInternalStoreDiff] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "diff": GithubComAspectrrFluidShFluidRemoteInternalStoreDiff.from_dict(
                    obj["diff"]
                )
                if obj.get("diff") is not None
                else None
            }
        )
        return _obj
