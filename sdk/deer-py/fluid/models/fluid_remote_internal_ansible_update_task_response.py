...
class FluidRemoteInternalAnsibleUpdateTaskResponse(BaseModel):
    """
    FluidRemoteInternalAnsibleUpdateTaskResponse
    """  # noqa: E501

    task: Optional[FluidRemoteInternalStorePlaybookTask] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "task": FluidRemoteInternalStorePlaybookTask.from_dict(obj["task"])
