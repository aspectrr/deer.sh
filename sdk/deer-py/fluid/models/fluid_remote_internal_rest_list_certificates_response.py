...
class FluidRemoteInternalRestListCertificatesResponse(BaseModel):
    """
    FluidRemoteInternalRestListCertificatesResponse
    """  # noqa: E501

    certificates: Optional[List[FluidRemoteInternalRestCertificateResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "certificates": [
                    FluidRemoteInternalRestCertificateResponse.from_dict(_item)
