...
// SandboxHostConfig configures a remote host running deer-daemon for sandbox operations.
...
type SSHConfig struct {
	...
	SourceKeyDir string        `yaml:"source_key_dir"` // Directory for source host SSH keys (default: ~/.config/deer/keys/)
...
func DefaultConfig() *Config {
	...
	return &Config{
		Provider: "libvirt",
		APIURL:   "https://api.deer.sh",
		WebURL:   "https://deer.sh",
