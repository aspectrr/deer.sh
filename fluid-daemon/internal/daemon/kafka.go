	...
	manager, err := kafkastub.NewManager(baseDir, redactor, logger,
		...
		kafkastub.WithHooks(kafkastub.Hooks{
			OnCaptureStatus: func(item kafkastub.CaptureStatus) {
				...
				_ = mergeCaptureStatus(context.Background(), store, item)
			},
			OnSandboxStub: func(stub *kafkastub.SandboxStub) {
				if store == nil {
					return
				}
				_ = store.UpsertSandboxKafkaStub(context.Background(), sandboxStubToState(stub))
			},
		}))
	if err != nil {
		return nil, err
...
func (s *Server) ListSandboxKafkaStubs(ctx context.Context, req *fluidv1.ListSandboxKafkaStubsCommand) (*fluidv1.ListSandboxKafkaStubsResponse, error) {
	if req.GetSandboxId() == "" {
		return nil, status.Error(codes.InvalidArgument, "sandbox_id is required")
	}
	if s.kafkaMgr == nil {
		return &fluidv1.ListSandboxKafkaStubsResponse{}, nil
	}
	...
	resp := &fluidv1.ListSandboxKafkaStubsResponse{Stubs: make([]*fluidv1.SandboxKafkaStubInfo, 0, len(stubs))}
	for _, stub := range stubs {
...
func (s *Server) GetSandboxKafkaStub(ctx context.Context, req *fluidv1.GetSandboxKafkaStubCommand) (*fluidv1.SandboxKafkaStubInfo, error) {
...
func (s *Server) StartSandboxKafkaStub(ctx context.Context, req *fluidv1.StartSandboxKafkaStubCommand) (*fluidv1.SandboxKafkaStubInfo, error) {
	return s.transitionSandboxKafkaStub(ctx, req.GetSandboxId(), req.GetStubId(), "start")
}

func (s *Server) StopSandboxKafkaStub(ctx context.Context, req *fluidv1.StopSandboxKafkaStubCommand) (*fluidv1.SandboxKafkaStubInfo, error) {
	return s.transitionSandboxKafkaStub(ctx, req.GetSandboxId(), req.GetStubId(), "stop")
}

func (s *Server) RestartSandboxKafkaStub(ctx context.Context, req *fluidv1.RestartSandboxKafkaStubCommand) (*fluidv1.SandboxKafkaStubInfo, error) {
	return s.transitionSandboxKafkaStub(ctx, req.GetSandboxId(), req.GetStubId(), "restart")
}

func (s *Server) transitionSandboxKafkaStub(ctx context.Context, sandboxID, stubID, action string) (*fluidv1.SandboxKafkaStubInfo, error) {
...
func (s *Server) GetKafkaCaptureStatus(ctx context.Context, req *fluidv1.KafkaCaptureStatusRequest) (*fluidv1.KafkaCaptureStatusResponse, error) {
	if s.kafkaMgr == nil {
		return &fluidv1.KafkaCaptureStatusResponse{}, nil
	}
	...
	resp := &fluidv1.KafkaCaptureStatusResponse{Statuses: make([]*fluidv1.KafkaCaptureStatus, 0, len(statuses))}
	for _, item := range statuses {
		_ = mergeCaptureStatus(ctx, s.store, item)
		resp.Statuses = append(resp.Statuses, &fluidv1.KafkaCaptureStatus{
...
func captureConfigFromProto(binding *fluidv1.KafkaCaptureConfigBinding) kafkastub.CaptureConfig {
...
func sandboxStubToProto(stub *kafkastub.SandboxStub) *fluidv1.SandboxKafkaStubInfo {
...
func stubStateToProto(v string) fluidv1.KafkaStubState {
	switch v {
